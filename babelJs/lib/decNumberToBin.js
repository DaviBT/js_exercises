...
console.log("O n\xFAmero ".concat(numero, " em bin\xE1rio \xE9 ").concat(binario));
...
binario = "1010"; // altere este valor para o número binário
let decimal = 0;
for (let i = binario.length - 1, j = 0; i >= 0; i--, j++) {
  decimal += parseInt(binario[i] * Math.pow(2, j));
}
console.log("O n\xFAmero  ".concat(binario, " em decimal \xE9 ").concat(decimal));
...
if (numero == reverso) {
  console.log("O n\xFAmero ".concat(numero, " \xE9 um pal\xEDndromo"));
} else {
  console.log("O n\xFAmero ".concat(numero, " n\xE3o \xE9 um pal\xEDndromo"));
}
...
console.log("A soma das matrizes \xE9 ".concat(JSON.stringify(soma)));
